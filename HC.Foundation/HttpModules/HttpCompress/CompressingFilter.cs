...
namespace HC.Foundation.HttpModules.HttpCompress
{
    ...
    public abstract class CompressingFilter : HttpOutputFilter
    {
        ...
        /// <param name="compressionLevels">The level of compression to use when compressing the content</param>
        protected CompressingFilter(Stream baseStream, CompressionLevels compressionLevels)
            : base(baseStream)
        {
            _compressionLevel = compressionLevels;
        }
