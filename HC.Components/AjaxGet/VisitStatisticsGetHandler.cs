...
namespace HC.Components.AjaxGet
{
    ...
    ///     访问记录Get请求响应类
    /// </summary>
    public class VisitStatisticsGetHandler : AjaxGetHandler
    {
        /// <summary>
        ///     取得分页列表
        /// </summary>
        ...
        public string GetPageData(string page, string pageSize)
        {
            try
            {
                Page<VisitStatistics> pageData = VisitStatisticsService.Instance.Page(page.ToInt(1), pageSize.ToInt32(10),
