<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
         CodeBehind="MenuSort.aspx.cs" Inherits="HC.WebSite.Admin.Menu.MenuSort" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="p" class="easyui-panel" data-options="tools:'#tt'" title="菜单排序" style="padding: 10px;">
        <p style="color: green">
