<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="AdminPurview.aspx.cs" Inherits="HC.WebSite.Admin.Account.AdminPurview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#table').treegrid({
                title: '编辑用户 <span style="color:red"><%=Name %></span> 菜单权限',
                url: '<%=BasePath%>ajaxget.aspx?_t='+new Date().getTime()+'&_action=MenuGetHandler.InitAdminMenuTree&adminId=<%=RequestInt32("Id") %>',
                method: 'get',
                rownumbers: true,
                idField: 'id',
                treeField: 'text',
                ...
                columns: [[ 
                    ...
                    { field: 'text', title: '名称', width: 220, align: 'left',
                ...
                toolbar: [
                    {
                        ...
                        handler: function () {
                            ...
                            $.hc.confirm("确定要保存用户菜单权限吗？", function () {
                                $.hc.ajax('AdminPostHandler.SetAdminMenuPurview', {
                                    params: { adminId: <%=RequestInt32("id") %>, purview: items },
