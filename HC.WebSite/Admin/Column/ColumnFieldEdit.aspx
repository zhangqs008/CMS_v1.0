<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="ColumnFieldEdit.aspx.cs" Inherits="HC.WebSite.Admin.Column.ColumnFieldEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="p" class="easyui-panel" title='<%=Column.Name %> <%= RequestString("action").ToLower() == "modify" ? "修改" : "添加" %>字段'
        style="background: #fafafa; height: 500px;">
        <table cellpadding="10" cellspacing="0" width="100%" class="edit_table">
            <tr style="display: none">
                <td colspan="2">
                    <input type="text" id="id" name="Id" data-options="required:true" value="<%=RequestInt32("Id") %>"
                        class="easyui-textbox"></input>
                    <input type="text" id="ModuleId" name="ModuleId" data-options="required:true" value="<%=Module.Id %>"
                        class="easyui-textbox"></input>
                    <input type="text" id="columnId" name="columnId" data-options="required:true" value="<%=Field.ColumnId %>"
                        class="easyui-textbox"></input>
                    <input type="text" id="TableName" name="TableName" data-options="required:true" value="<%=Field.TableName %>"
                        class="easyui-textbox"></input>
                    <input type="text" id="_action" name="_action" value="ColumnFieldFormHandler" class="easyui-textbox"></input>
                </td>
            </tr>
            <tr>
                ...
                <td class="panel-header td_right">
                    <input type="text" id="txtNote" name="Note" value="<%=Field.Note %>" style="width: 150px;"
                        data-options="required:true,missingMessage:' 备注名称不能为空'" class="easyui-textbox"></input>
                </td>
            </tr>
            <tr>
                <td class="panel-header td_left">
                ...
                <td class="panel-header td_right">
                    <input type="text" id="txtName" name="Name" value="<%=Field.Name %>" style="width: 150px;"
                        data-options="editable:false,required:true,missingMessage:' 字段名称不能为空'" class="easyui-textbox"></input>
                    （字段名称只能为英文并无空格）
                </td>
            </tr>
            <tr>
                ...
                <td class="panel-header td_right">
                    <input type="text" id="Tips" name="Tips" value="<%=Field.Tips %>" style="width: 300px;"
                        data-options="" class="easyui-textbox"></input>
                </td>
            </tr>
            <tr>
                <td class="panel-header td_left">
                ...
                <td class="panel-header td_right">
                    <input type="text" id="DefaultValue" value="<%=Field.DefaultValue %>" name="DefaultValue"
                        style="width: 300px;" data-options="" class="easyui-textbox"></input>
                </td>
            </tr>
            <tr>
                <td class="panel-header td_left">
                ...
                <td class="panel-header td_right">
                    ...
                    <script type="text/javascript">
                        //                        $(function () { $('#Type').combobox('disable'); })
                    </script>
                </td>
            </tr>
            <%--单行文本--%>
            ...
            <tr class="FieldConfig" typeid="<%=(int)ModuleFieldType.TextBox %>" style="<%=GetFieldStyle((int)ModuleFieldType.TextBox)%>">
                ...
                <td class="panel-header td_right">
                    <input type="radio" value="0" name="TextBoxAllowNull" <%=FieldOption.TextBoxAllowNull?"":"checked=\"checked\"" %>></input>否<input
                        type="radio" value="1" name="TextBoxAllowNull" <%=FieldOption.TextBoxAllowNull?"checked=\"checked\"":"" %>></input>是
                </td>
            </tr>
            <tr class="FieldConfig" typeid="<%=(int)ModuleFieldType.TextBox %>" style="<%=GetFieldStyle((int)ModuleFieldType.TextBox)%>">
                <td class="panel-header td_left">
            ...
            <tr class="FieldConfig" typeid="<%=(int)ModuleFieldType.Editer %>" style="<%=GetFieldStyle((int)ModuleFieldType.Editer)%>">
                ...
                <td class="panel-header td_right">
                    <select id="cc" class="easyui-combobox" name="EditerStyle" style="width: 100px;">
                        <option value="default" <%=FieldOption.EditerStyle.ToStr().ToLower()=="default"?"selected='selected'":"" %>>默认模式</option>
                        <option value="simple" <%=FieldOption.EditerStyle.ToStr().ToLower()=="simple"?"selected='selected'":"" %>>精简模式</option>
                    </select>
                </td>
            </tr>
            <tr>
